...
extern "C" {
	...
	namespace fq::physics
	{
		...
		public:
			...
			/// </summary>
			virtual FQ_PHYSICS RayCastData RayCast(unsigned int myID, unsigned int layerNumber, const DirectX::SimpleMath::Vector3& origin, const DirectX::SimpleMath::Vector3& direction, const float& distance) abstract;
