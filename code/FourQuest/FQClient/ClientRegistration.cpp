...
void fq::client::RegisterMetaData()
{
	...
	entt::meta<ArmourDestroyer>()
		...
		.prop(fq::reflect::prop::Comment, u"떨어진 갑옷이 남는지 여부")
		.base<game_module::Component>();
	...
	entt::meta<DestroyHelper>()
		.type("DestroyHelper"_hs)
		.prop(reflect::prop::Name, "DestroyHelper")
	...
	entt::meta<EBossMonsterAttackType>()
		.prop(fq::reflect::prop::Name, "EBossMonsterAttackType")
		.conv<std::underlying_type_t<EBossMonsterAttackType>>()
		.data<EBossMonsterAttackType::Rush>("Rush"_hs) // 0
		.prop(fq::reflect::prop::Name, "Rush")
		.data<EBossMonsterAttackType::SmashDown>("SmashDown"_hs) // 1
		.prop(fq::reflect::prop::Name, "SmashDown")
		.data<EBossMonsterAttackType::Combo>("Combo"_hs) // 2
		.prop(fq::reflect::prop::Name, "Combo")
		.data<EBossMonsterAttackType::Roar>("Roar"_hs) // 3
		.prop(fq::reflect::prop::Name, "Roar")
		.data<EBossMonsterAttackType::Continous>("Continous"_hs) // 4
		.prop(fq::reflect::prop::Name, "Continous")
		.data<EBossMonsterAttackType::Eat>("Eat"_hs) // 5
		.prop(fq::reflect::prop::Name, "Eat")
		.data<EBossMonsterAttackType::Jump>("Jump"_hs) // 6
		.prop(fq::reflect::prop::Name, "Jump");
	...
	entt::meta<BossMonster>()
		...
		.prop(fq::reflect::prop::Comment, u8"콤보 공격 넉백량")
		.data<&BossMonster::mContinousKnockBackPower>("ContinousKnockBackPower"_hs)
		.prop(fq::reflect::prop::Name, "ContinousKnockBackPower")
		.prop(fq::reflect::prop::Comment, u8"콤비네이션 공격 넉백량")
		.data<&BossMonster::mJumpAttackKnockBack>("mJumpAttackKnockBack"_hs)
		.prop(fq::reflect::prop::Name, "mJumpAttackKnockBack")
		.prop(fq::reflect::prop::Comment, u8"점프 공격 넉백량")
		.data<&BossMonster::mAttackCoolTime>("AttackCoolTime"_hs)
		.prop(fq::reflect::prop::Name, "AttackCoolTime")
		.prop(fq::reflect::prop::Comment, u8"현재 공격 쿨타임(에디터 데이터 파악용)")
		.data<&BossMonster::mMinWaitAttackTime>("MinWaitAttackTime"_hs)
		.prop(fq::reflect::prop::Name, "minWaitAttackTime")
		.prop(fq::reflect::prop::Comment, u8"최소 공격 쿨타임")
		.data<&BossMonster::mMaxWaitAttackTime>("MaxWaitAttackTime"_hs)
		.prop(fq::reflect::prop::Name, "MaxWaitAttackTime")
		.prop(fq::reflect::prop::Comment, u8"최대 공격 쿨타임")

		.data<&BossMonster::mSmashDownOffset>("SmashDownOffset"_hs)
		.prop(fq::reflect::prop::Name, "SmashDownOffset")
		.prop(fq::reflect::prop::Comment, u8"스매시 공격 오프셋(위치 조정용)")
		.data<&BossMonster::mComboAttackOffset>("ComboAttackOffset"_hs)
		.prop(fq::reflect::prop::Name, "ComboAttackOffset")
		.prop(fq::reflect::prop::Comment, u8"콤보 공격 오프셋(위치 조정용)")
		.data<&BossMonster::mSecondComboAttackRatio>("SecondComboAttackRatio"_hs)
		.prop(fq::reflect::prop::Name, "SecondComboAttackRatio")
		.prop(fq::reflect::prop::Comment, u8"콤보 공격 2타까지만 사용할 확률(0 ~ 1)")
		.data<&BossMonster::mComboAttackReboundPower>("ComboAttackReboundPower"_hs)
		.prop(fq::reflect::prop::Name, "ComboAttackReboundPower")
		.prop(fq::reflect::prop::Comment, u8"콤보 공격 시 돌진량")
		.data<&BossMonster::mContinousAttackReboundPower>("ContinousAttackReboundPower"_hs)
		.prop(fq::reflect::prop::Name, "ContinousAttackReboundPower")
		.prop(fq::reflect::prop::Comment, u8"연속 공격 시 돌진량")
		.data<&BossMonster::mEffectYOffset>("EffectYOffset"_hs)
		.prop(fq::reflect::prop::Name, "EffectYOffset")
		.prop(fq::reflect::prop::Comment, u8"이펙트 방출 시 Y Offset(가려짐 방지용)")

		.data<&BossMonster::mStartGroggyGauge>("StartGroggyGauge"_hs)
		.prop(fq::reflect::prop::Name, "StartGroggyGauge")
		.prop(fq::reflect::prop::Comment, u8"그로기 시작 게이지(그로기 게이지의 최대량)")
		...
		.prop(fq::reflect::prop::Comment, u8"그로기 상태가 아닐 시 초당 그로기 게이지 감소량")
		...
		.prop(fq::reflect::prop::Comment, u8"스매시 공격 프리팹")
		.data<&BossMonster::mComboAttack>("ComboAttack"_hs)
		.prop(fq::reflect::prop::Name, "ComboAttack")
		.prop(fq::reflect::prop::Comment, u8"콤보 공격 프리팹")
		.data<&BossMonster::mRushAttack>("RushAttack"_hs)
		.prop(fq::reflect::prop::Name, "RushAttack")
		.prop(fq::reflect::prop::Comment, u8"돌진 공격 프리팹")
		.data<&BossMonster::mJumpDownAttack>("mJumpDownAttack"_hs)
		.prop(fq::reflect::prop::Name, "mJumpDownAttack")
		.prop(fq::reflect::prop::Comment, u8"점프 공격 프리팹")

		.data<&BossMonster::mSmashDownEffect>("SmashDownEffect"_hs)
		.prop(fq::reflect::prop::Name, "SmashDownEffect")
		.prop(fq::reflect::prop::Comment, u8"스매시 공격 이펙트 프리팹")
		.data<&BossMonster::mSmashDownDecalEffect>("mSmashDownDecalEffect"_hs)
		.prop(fq::reflect::prop::Name, "mSmashDownDecalEffect")
		.prop(fq::reflect::prop::Comment, u8"스매시 공격 데칼 이펙트 프리팹")
		.data<&BossMonster::mComboEffect>("ComboEffect"_hs)
		.prop(fq::reflect::prop::Name, "ComboEffect")
		.prop(fq::reflect::prop::Comment, u8"콤보 공격 이펙트 프리팹")
		.data<&BossMonster::mComboDecalEffect>("ComboDecalEffect"_hs)
		.prop(fq::reflect::prop::Name, "ComboDecalEffect")
		.prop(fq::reflect::prop::Comment, u8"콤보 공격 데칼 이펙트 프리팹")
		.data<&BossMonster::mRushEffect>("RushEffect"_hs)
		.prop(fq::reflect::prop::Name, "RushEffect")
		.prop(fq::reflect::prop::Comment, u8"돌진 공격 이펙트 프리팹")
		.data<&BossMonster::mRushDecalEffect>("RushDecalEffect"_hs)
		.prop(fq::reflect::prop::Name, "RushDecalEffect")
		.prop(fq::reflect::prop::Comment, u8"돌진 공격 데칼 이펙트 프리팹")
		.data<&BossMonster::mJumpEffect>("JumpEffect"_hs)
		.prop(fq::reflect::prop::Name, "JumpEffect")
		.prop(fq::reflect::prop::Comment, u8"점프 공격 이펙트 프리팹")
		.data<&BossMonster::mJumpDecalEffect>("mJumpDecalEffect"_hs)
		.prop(fq::reflect::prop::Name, "mJumpDecalEffect")
		.prop(fq::reflect::prop::Comment, u8"점프 공격 데칼 이펙트 프리팹")
		.data<&BossMonster::mJumpDecalEndEffect>("mJumpDecalEndEffect"_hs)
		.prop(fq::reflect::prop::Name, "mJumpDecalEndEffect")
		.prop(fq::reflect::prop::Comment, u8"점프 공격 위치 확정 데칼 이펙트 프리팹")

		.data<&BossMonster::mHpBarPrefab>("HpBarPrefab"_hs)
		.prop(fq::reflect::prop::Name, "HpBarPrefab")
		.prop(fq::reflect::prop::Comment, u8"체력 게이지 프리팹")
		...
		.data<&BossMonster::mJumpDistance>("mJumpDistance"_hs)
		.prop(fq::reflect::prop::Name, "mJumpDistance")
		.prop(fq::reflect::prop::Comment, u8"점프를 시도할 최소 범위")
		.data<&BossMonster::mJumpAttackPower>("mJumpAttackPower"_hs)
		.prop(fq::reflect::prop::Name, "mJumpAttackPower")
		.prop(fq::reflect::prop::Comment, u8"점프 공격 대미지")
		.data<&BossMonster::mDefaultJumpPosition>("mDefaultJumpPosition"_hs)
		.prop(fq::reflect::prop::Name, "mDefaultJumpPosition")
		.prop(fq::reflect::prop::Comment, u8"점프 위치 못 찾을 시 점프할 곳")
		.data<&BossMonster::mJumpCoolTime>("mJumpCoolTime"_hs)
		.prop(fq::reflect::prop::Name, "mJumpCoolTime")
		.prop(fq::reflect::prop::Comment, u8"점프 쿨타임(실제로 점프가 실행된 이후부터)")

		.data<&BossMonster::mAngryRatio>("mAngryRatio"_hs)
		.prop(fq::reflect::prop::Name, "mAngryRatio")
		.prop(fq::reflect::prop::Comment, u8"화남 상태에 돌입하는 체력 비율")
		.data<&BossMonster::mAngrySpeedRatio>("mAngrySpeedRatio"_hs)
		.prop(fq::reflect::prop::Name, "mAngrySpeedRatio")
		.prop(fq::reflect::prop::Comment, u8"화남 상태의 이동속도 비율")
		.data<&BossMonster::mAngryCoolTimeRatio>("mAngryCoolTimeRatio"_hs)
		.prop(fq::reflect::prop::Name, "mAngryCoolTimeRatio")
		.prop(fq::reflect::prop::Comment, u8"화남 상태의 쿨타임 비율")
		.data<&BossMonster::mAngryPreAttackSpeedRatio>("mAngryPreAttackSpeedRatio"_hs)
		.prop(fq::reflect::prop::Name, "mAngryPreAttackSpeedRatio")
		.prop(fq::reflect::prop::Comment, u8"화남 상태의 공격 대기 시간 속도 비율")
		.data<&BossMonster::mAngryAttackSpeedRatio>("mAngryAttackSpeedRatio"_hs)
		.prop(fq::reflect::prop::Name, "mAngryAttackSpeedRatio")
		.prop(fq::reflect::prop::Comment, u8"화남 상태의 공격 속도 비율")
		.data<&BossMonster::mAngryAttackPowerRatio>("mAngryAttackPowerRatio"_hs)
		.prop(fq::reflect::prop::Name, "mAngryAttackPowerRatio")
		.prop(fq::reflect::prop::Comment, u8"화남 상태 공격력 비율")
		.data<&BossMonster::mAngryEnteringVigilantCount>("mAngryEnteringVigilantCount"_hs)
		...
		.prop(fq::reflect::prop::Comment, u8"울부짖음 사용 가능한 최소 몬스터 량")
	...
	entt::meta<BossMonsterPrepareAttackState>()
		...
		.prop(fq::reflect::prop::Name, "HomingTime")
		.data<&BossMonsterPrepareAttackState::mAttackType>("mAttackType"_hs)
		.prop(fq::reflect::prop::Name, "mAttackType")
		.data<&BossMonsterPrepareAttackState::mEffectXOffset>("mEffectXOffset"_hs)
		.prop(fq::reflect::prop::Name, "mEffectXOffset")
		.data<&BossMonsterPrepareAttackState::mbUseStepBack>("mbUseStepBack"_hs)
		.prop(fq::reflect::prop::Name, "mbUseStepBack")
		.data<&BossMonsterPrepareAttackState::mbUseRebind>("mbUseRebind"_hs)
		.prop(fq::reflect::prop::Name, "mbUseRebind")
		.data<&BossMonsterPrepareAttackState::mbUseRotationSpeed>("mbUseRotationSpeed"_hs)
		.prop(fq::reflect::prop::Name, "mbUseRotationSpeed")
		.base<fq::game_module::IStateBehaviour>();

	entt::meta<BossMonsterGroggyState>()
		.type("BossMonsterGroggyState"_hs)
		.prop(fq::reflect::prop::Name, "BossMonsterGroggyState")
		.data<&BossMonsterGroggyState::mCollisionRadius>("CollisionRadius"_hs)
		.prop(fq::reflect::prop::Name, "CollisionRadius")
		.data<&BossMonsterGroggyState::mCollisionOffset>("CollisionOffset"_hs)
		.prop(fq::reflect::prop::Name, "CollisionOffset")
		.base<fq::game_module::IStateBehaviour>();
	...
	entt::meta<BossMonsterRoarState>()
		...
		.data<&BossMonsterRoarState::mChangeColorDuration>("mChangeColorDuration"_hs)
		.prop(fq::reflect::prop::Name, "mChangeColorDuration")
		.data<&BossMonsterRoarState::mStartColor>("mStartColor"_hs)
		.prop(fq::reflect::prop::Name, "mStartColor")
		.data<&BossMonsterRoarState::mEndColor>("mEndColor"_hs)
		.prop(fq::reflect::prop::Name, "mEndColor")
		.data<&BossMonsterRoarState::mStartInvRimPow>("mStartInvRimPow"_hs)
		.prop(fq::reflect::prop::Name, "mStartInvRimPow")
		.data<&BossMonsterRoarState::mEndInvRimPow>("mEndInvRimPow"_hs)
		.prop(fq::reflect::prop::Name, "mEndInvRimPow")
		.base<fq::game_module::IStateBehaviour>();
	...
	entt::meta<BossMonsterPreJumpState>()
		.type("BossMonsterPreJumpState"_hs)
		.prop(fq::reflect::prop::Name, "BossMonsterPreJumpState")
		.data<&BossMonsterPreJumpState::mWaitingTime>("mWaitingTime"_hs)
		.prop(fq::reflect::prop::Name, "mWaitingTime")
		.prop(fq::reflect::prop::Comment, u8"점프 대기 시간")
		.data<&BossMonsterPreJumpState::mTargetCaptureTime>("mTargetCaptureTime"_hs)
		.prop(fq::reflect::prop::Name, "mTargetCaptureTime")
		.prop(fq::reflect::prop::Comment, u8"점프 위치 확정 시간")
		.base<fq::game_module::IStateBehaviour>();

	entt::meta<BossMonsterJumpState>()
		.type("BossMonsterJumpState"_hs)
		.prop(fq::reflect::prop::Name, "BossMonsterJumpState")
		.data<&BossMonsterJumpState::mMaxY>("mMaxY"_hs)
		.prop(fq::reflect::prop::Name, "mMaxY")
		.prop(fq::reflect::prop::Comment, u8"가장 높게 뜬 Y 값")
		.data<&BossMonsterJumpState::mJumpDuration>("mJumpDuration"_hs)
		.prop(fq::reflect::prop::Name, "mJumpDuration")
		.prop(fq::reflect::prop::Comment, u8"체공 시간")
		.data<&BossMonsterJumpState::mAttackGenateTime>("mAttackGenateTime"_hs)
		.prop(fq::reflect::prop::Name, "mAttackGenateTime")
		.prop(fq::reflect::prop::Comment, u8"공격 생성 시간")
		.data<&BossMonsterJumpState::mEffectGenateTime>("mEffectGenateTime"_hs)
		.prop(fq::reflect::prop::Name, "mEffectGenateTime")
		.prop(fq::reflect::prop::Comment, u8"이펙트 생성 시간")
		.base<fq::game_module::IStateBehaviour>();

	entt::meta<BossMonsterVigilantState>()
		.type("BossMonsterVigilantState"_hs)
		.prop(fq::reflect::prop::Name, "BossMonsterVigilantState")
		.data<&BossMonsterVigilantState::mAngryVigilantDuration>("mAngryVigilantDuration"_hs)
		.prop(fq::reflect::prop::Name, "mAngryVigilantDuration")
		.prop(fq::reflect::prop::Comment, u8"화난 상태에서 대기 시간")
		.data<&BossMonsterVigilantState::mVigilantDuration>("mVigilantDuration"_hs)
		.prop(fq::reflect::prop::Name, "mVigilantDuration")
		.prop(fq::reflect::prop::Comment, u8"일반 상태에서 대기 시간")
		.base<fq::game_module::IStateBehaviour>();

	entt::meta<BossMonsterVigilantCountingState>()
		.type("BossMonsterVigilantCountingState"_hs)
		.prop(fq::reflect::prop::Name, "BossMonsterVigilantCountingState")
		.base<fq::game_module::IStateBehaviour>();
	...
	entt::meta<Quest>()
		...
		.prop(fq::reflect::prop::Name, "Name")
		.data<&Quest::mIsTime>("IsTime"_hs)
		.prop(fq::reflect::prop::Name, "IsTime")
		.data<&Quest::mSeconds>("Seconds"_hs)
	...
	entt::meta<Box>()
		...
		.data<&Box::mBrokenBoxPrefabPath>("BrokenBoxPrefabPath"_hs)
		.prop(reflect::prop::Name, "BrokenBoxPrefabPath")
