...
bool LightMapDemo::Init(HINSTANCE hInstance)
{
	/// 기본적인 초기화
...
void LightMapDemo::Finalize()
{

}

LRESULT LightMapDemo::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	HDC			hdc;
	PAINTSTRUCT ps;
...
void LightMapDemo::calculateFrameStats()
{
...
void LightMapDemo::createModel(std::string modelPath, std::filesystem::path textureBasePath, DirectX::SimpleMath::Matrix transform, bool bIsCreateHierarchy)
{
