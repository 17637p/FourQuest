...
extern "C" {
	...
	namespace fq::graphics
	{
		...
		public:
			...
			virtual FQ_GRAPHICS DebugInfo GetDebugInfo() const abstract;
			...
			// Video
			virtual FQ_GRAPHICS IVideoObject* CreateVideoObject(VideoInfo videoInfo) abstract;
			virtual FQ_GRAPHICS void DeleteVideoObject(fq::graphics::IVideoObject* videoObject) abstract;
