...
namespace fq::graphics
{
		...
		EPipelineType pipelineType)
	{
		...
		case fq::graphics::EPipelineType::Forward:
			mForwardPipeline->Initialize(device, jobManager, cameraManager, lightManager, resourceManager, debugDrawManager, particleManager, decalManager, lightProbeManager, width, height);
			break;
