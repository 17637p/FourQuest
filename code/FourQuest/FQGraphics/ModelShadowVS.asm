...
// cbBoneTransform                   cbuffer      NA          NA            cb1      1 
//
//
//
// Input signature:
...
mul r1.x, v5.x, cb1[r0.x + 0].w
mul r1.y, v5.x, cb1[r0.x + 1].w
mul r1.z, v5.x, cb1[r0.x + 2].w
mul r1.w, v5.x, cb1[r0.x + 3].w
mul r2.x, v5.y, cb1[r0.y + 0].w
mul r2.y, v5.y, cb1[r0.y + 1].w
mul r2.z, v5.y, cb1[r0.y + 2].w
mul r2.w, v5.y, cb1[r0.y + 3].w
add r1.xyzw, r1.xyzw, r2.xyzw
mul r2.x, v5.z, cb1[r0.z + 0].w
mul r2.y, v5.z, cb1[r0.z + 1].w
mul r2.z, v5.z, cb1[r0.z + 2].w
mul r2.w, v5.z, cb1[r0.z + 3].w
add r1.xyzw, r1.xyzw, r2.xyzw
mul r2.x, v5.w, cb1[r0.w + 0].w
mul r2.y, v5.w, cb1[r0.w + 1].w
mul r2.z, v5.w, cb1[r0.w + 2].w
mul r2.w, v5.w, cb1[r0.w + 3].w
add r1.xyzw, r1.xyzw, r2.xyzw
dp4 r2.w, r1.xyzw, cb0[0].xyzw
mul r3.xyz, v5.xxxx, cb1[r0.x + 0].yxzy
mov r4.x, r3.y
mul r5.xyz, v5.xxxx, cb1[r0.x + 1].xzyx
mov r4.y, r5.x
mul r6.xyz, v5.xxxx, cb1[r0.x + 2].xyzx
mov r4.z, r6.x
mul r7.xyz, v5.xxxx, cb1[r0.x + 3].xyzx
mov r4.w, r7.x
mul r8.xyz, v5.yyyy, cb1[r0.y + 0].yxzy
mov r9.x, r8.y
mul r10.xyz, v5.yyyy, cb1[r0.y + 1].xzyx
mov r9.y, r10.x
mul r11.xyz, v5.yyyy, cb1[r0.y + 2].xyzx
mov r9.z, r11.x
mul r12.xyz, v5.yyyy, cb1[r0.y + 3].xyzx
mov r9.w, r12.x
add r4.xyzw, r4.xyzw, r9.xyzw
mul r9.xyz, v5.zzzz, cb1[r0.z + 0].yxzy
mov r13.x, r9.y
mul r14.xyz, v5.zzzz, cb1[r0.z + 1].xzyx
mov r13.y, r14.x
mul r15.xyz, v5.zzzz, cb1[r0.z + 2].xyzx
mov r13.z, r15.x
mul r0.xyz, v5.zzzz, cb1[r0.z + 3].xyzx
mov r13.w, r0.x
add r4.xyzw, r4.xyzw, r13.xyzw
mul r13.xyz, v5.wwww, cb1[r0.w + 0].yxzy
mov r16.x, r13.y
mul r17.xyz, v5.wwww, cb1[r0.w + 1].xzyx
mov r16.y, r17.x
mul r18.xyz, v5.wwww, cb1[r0.w + 2].xyzx
mul r19.xyz, v5.wwww, cb1[r0.w + 3].xyzx
mov r16.z, r18.x
mov r16.w, r19.x
...
dp4 r2.x, r4.xyzw, cb0[2].xyzw
dp4 r4.x, r4.xyzw, cb0[3].xyzw
dp4 r2.y, r3.xyzw, cb0[2].xyzw
