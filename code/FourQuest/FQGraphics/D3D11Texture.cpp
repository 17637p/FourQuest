...
fq_graphics::D3D11Texture::D3D11Texture(const std::shared_ptr<D3D11ResourceManager>& resourceManager, const std::shared_ptr<D3D11Device>& d3d11Device, const std::wstring& texturePath)
...
std::string fq_graphics::D3D11Texture::GenerateRID(const std::wstring& texturePath)
{
	std::string temp;
...
void fq_graphics::D3D11Texture::Bind(const std::shared_ptr<D3D11Device>& d3d11Device, const UINT startSlot, const ED3D11ShaderType eShaderType)
{
	switch (eShaderType)
	{
