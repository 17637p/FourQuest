...
void fq::game_module::RegisterMetaData()
{
	...
	entt::meta<StaticMeshRenderer>()
		...
		.prop(fq::reflect::prop::RelativePath)
		.data<&StaticMeshRenderer::SetTexturePath, &StaticMeshRenderer::GetTexturePath>("TexturePath"_hs)
		.prop(fq::reflect::prop::Name, "TexturePath")
		.prop(fq::reflect::prop::RelativePath)
		.prop(fq::reflect::prop::DragDrop, ".dir")
	...
	entt::meta<SkinnedMeshRenderer>()
		...
		.prop(fq::reflect::prop::RelativePath)
		.data<&SkinnedMeshRenderer::SetTexturePath, &SkinnedMeshRenderer::GetTexturePath>("TexturePath"_hs)
		.prop(fq::reflect::prop::Name, "TexturePath")
		.prop(fq::reflect::prop::RelativePath)
		.prop(fq::reflect::prop::DragDrop, ".dir")
	...
	entt::meta<SoundTrackInfo>()
		...
		.data<&fq::game_module::SoundTrackInfo::soundPath>("SoundPath"_hs)
		.prop(fq::reflect::prop::Name, "SoundPath")
		.prop(fq::reflect::prop::RelativePath)
		.prop(fq::reflect::prop::DragDrop, ".wav")
		.prop(fq::reflect::prop::Comment, u8"재생할 사운드를 드로그 앤 드랍하세요.")
