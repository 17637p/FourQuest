...
void fq::game_module::RegisterMetaData()
{
	...
	entt::meta<ImageUI>()
		...
		.data<&ImageUI::mbUssScreenScale>("mbUssScreenScale"_hs)
		.prop(fq::reflect::prop::Name, "mbUssScreenScale")
		.prop(fq::reflect::prop::Comment, u8"스크린 사이즈에 따라서 위치 변경 옵션")
		...
		.data<&ImageUI::mbUseCenterAlignment>("UseCenterAlignment"_hs)
		.prop(fq::reflect::prop::Name, "UseCenterAlignment")
		.prop(fq::reflect::prop::Comment, u8"중앙정렬 옵션")
		.data<&ImageUI::mCenterOffset>("CenterOffset"_hs)
		.prop(fq::reflect::prop::Name, "CenterOffset")
		.base<Component>();
	...
	entt::meta<ClothCollider>()
		...
		.data<&ClothCollider::SetMaxWindStrength, &ClothCollider::GetMaxWindStrength>("MaxWindStrength"_hs)
		.prop(fq::reflect::prop::Name, "MaxWindStrength")
		.prop(fq::reflect::prop::Comment, u8"최대 풍력 강도 : 천에 작용하는 바람의 강도를 조정합니다.")
	...
	entt::meta<PlayerMoveTrackInfo>()
		.type("PlayerMoveTrackInfo"_hs)
		.prop(fq::reflect::prop::Name, "PlayerMoveTrackInfo")
		.prop(fq::reflect::prop::POD)
		...
		.prop(fq::reflect::prop::Name, "StartTime")
		.prop(fq::reflect::prop::Comment, u8"시퀀스가 시작되고 난 뒤에 시작할 시간")
		.data<&fq::game_module::PlayerMoveTrackInfo::totalPlayTime>("TotalPlayTime"_hs)
		.prop(fq::reflect::prop::Name, "TotalPlayTime")
		.prop(fq::reflect::prop::Comment, u8"해당 트랙이 실행되고 난 뒤에 실행할 총 시간")
		.data<&fq::game_module::PlayerMoveTrackInfo::playerID>("playerID"_hs)
		.prop(fq::reflect::prop::Name, "playerID")
		.prop(fq::reflect::prop::Comment, u8"움직일 플레이어 아이디")
		.data<&fq::game_module::PlayerMoveTrackInfo::keys>("Keys"_hs)
		.prop(fq::reflect::prop::Name, "Keys");

	entt::meta<PlayerTeleportTrackInfo>()
		.type("PlayerTeleportTrackInfo"_hs)
		.prop(fq::reflect::prop::Name, "PlayerTeleportTrackInfo")
		.prop(fq::reflect::prop::POD)
		.data<&fq::game_module::PlayerTeleportTrackInfo::isObjectReturnToStartTransform>("isObjectReturnToStartTransform"_hs)
		.prop(fq::reflect::prop::Name, "isObjectReturnToStartTransform")
		.prop(fq::reflect::prop::Comment, u8"시퀀스가 종료된 이후 해당 오브젝트를 원위치로 되돌릴지 여부")
		.data<&fq::game_module::PlayerTeleportTrackInfo::startTime>("StartTime"_hs)
		.prop(fq::reflect::prop::Name, "StartTime")
		.prop(fq::reflect::prop::Comment, u8"시퀀스가 시작되고 난 뒤에 시작할 시간")
		.data<&fq::game_module::PlayerTeleportTrackInfo::totalPlayTime>("TotalPlayTime"_hs)
		.prop(fq::reflect::prop::Name, "TotalPlayTime")
		.prop(fq::reflect::prop::Comment, u8"해당 트랙이 실행되고 난 뒤에 실행할 총 시간")
		.data<&fq::game_module::PlayerTeleportTrackInfo::playerID>("playerID"_hs)
		.prop(fq::reflect::prop::Name, "playerID")
		.prop(fq::reflect::prop::Comment, u8"움직일 플레이어 아이디")
		.data<&fq::game_module::PlayerTeleportTrackInfo::keys>("Keys"_hs)
		.prop(fq::reflect::prop::Name, "Keys");
	...
	entt::meta<ObjectAnimationInfo>()
		...
		.prop(fq::reflect::prop::POD)
		.data<&fq::game_module::ObjectAnimationInfo::isLoop>("IsLoop"_hs)
		.prop(fq::reflect::prop::Name, "IsLoop")
		.prop(fq::reflect::prop::Comment, u8"애니메이션을 루프할 것인지 여부입니다.")
	...
	entt::meta<TextPrintTrackInfo>()
		...
		.data<&fq::game_module::TextPrintTrackInfo::nameFontCenterX>("nameFontCenterX"_hs)
		.prop(fq::reflect::prop::Name, "nameFontCenterX")
		.prop(fq::reflect::prop::Comment, u8"이름 폰트 X좌표 위치")
		...
		.data<&fq::game_module::TextPrintTrackInfo::textFontCenterX>("textFontCenterX"_hs)
		.prop(fq::reflect::prop::Name, "textFontCenterX")
		.prop(fq::reflect::prop::Comment, u8"대사 폰트 X좌표 위치")
	...
	entt::meta<ECreateDeleteMode>()
		.prop(fq::reflect::prop::Name, "CreateDeleteMode")
		.conv<std::underlying_type_t<ECreateDeleteMode>>()
		.data<ECreateDeleteMode::Create>("Create"_hs)
		.prop(fq::reflect::prop::Name, "Create")
		.data<ECreateDeleteMode::Delete>("Delete"_hs)
		.prop(fq::reflect::prop::Name, "Delete")
		.data<ECreateDeleteMode::CreateDelete>("CreateDelete"_hs)
		.prop(fq::reflect::prop::Name, "CreateDelete");

	entt::meta<CreateDeleteTrackInfo>()
		.type("CreateDeleteTrackInfo"_hs)
		.prop(fq::reflect::prop::Name, "CreateDeleteTrackInfo")
		.prop(fq::reflect::prop::POD)
		.data<&fq::game_module::CreateDeleteTrackInfo::startTime >("StartTime"_hs)
		.prop(fq::reflect::prop::Name, "StartTime")
		.prop(fq::reflect::prop::Comment, u8"시작 시간 (생성시간과 동일)")
		.data<&fq::game_module::CreateDeleteTrackInfo::totalPlayTime >("TotalPlayTime"_hs)
		.prop(fq::reflect::prop::Name, "TotalPlayTime")
		.prop(fq::reflect::prop::Comment, u8"플레이 시간 (삭제 시간과 동일)")
		.data<&fq::game_module::CreateDeleteTrackInfo::mode >("Mode"_hs)
		.prop(fq::reflect::prop::Name, "Mode")
		.prop(fq::reflect::prop::Comment, u8"모드")
		.data<&fq::game_module::CreateDeleteTrackInfo::prefabIndex >("PrefabIndex"_hs)
		.prop(fq::reflect::prop::Name, "PrefabIndex")
		.prop(fq::reflect::prop::Comment, u8"시퀀스 컴포넌트에서 사용하는 프리팹리소스 인덱스")
		.data<&fq::game_module::CreateDeleteTrackInfo::deleteName >("DeleteName"_hs)
	...
	entt::meta<Sequence>()
		...
		.data<&Sequence::SetPlayerMoveTrackInfo, &Sequence::GetPlayerMoveTrackInfo>("PlayerMoveTrackInfo"_hs)
		.prop(fq::reflect::prop::Name, "PlayerMoveTrackInfo")
		.prop(fq::reflect::prop::Comment, u8"만들고 싶은 플레이어 이동 트랙이 있다면 추가하면 됩니다.")
		.data<&Sequence::SetPlayerTeleportTrackInfo, &Sequence::GetPlayerTeleportTrackInfo>("PlayerTeleportTrackInfo"_hs)
		.prop(fq::reflect::prop::Name, "PlayerTeleportTrackInfo")
		.prop(fq::reflect::prop::Comment, u8"만들고 싶은 플레이어 순간이동 트랙이 있다면 추가하면 됩니다.")
	...
	entt::meta<SoundEmitter>()
		...
		.prop(fq::reflect::prop::Label, "Audio")
		.data<&SoundEmitter::mbIsActive>("IsActive"_hs)
		.prop(reflect::prop::Name, "IsActive")
		.prop(reflect::prop::Comment, u8"활성화 여부")
	...
	entt::meta<DecalGeoKeyframe>()
		.type("DecalGeoKeyframe"_hs)
		.prop(fq::reflect::prop::POD)
		.prop(fq::reflect::prop::Name, "DecalGeoKeyframe")
		.data<&DecalGeoKeyframe::TimePos>("TimePos"_hs)
		.prop(fq::reflect::prop::Name, "TimePos")
		.data<&DecalGeoKeyframe::Translation>("Translation"_hs)
		.prop(fq::reflect::prop::Name, "Translation")
		.data<&DecalGeoKeyframe::Scale>("Scale"_hs)
		.prop(fq::reflect::prop::Name, "Scale")
		.data<&DecalGeoKeyframe::Rotation>("Rotation"_hs)
		.prop(fq::reflect::prop::Name, "Rotation");
	...
	entt::meta<DecalUVAnimator>()
		...
		.data<&DecalUVAnimator::mDecalKeyframes>("DecalKeyframes"_hs)
