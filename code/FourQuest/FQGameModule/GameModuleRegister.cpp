...
void fq::game_module::RegisterMetaData()
{
	...
	entt::meta<ImageUI>()
		...
		.data<&ImageUI::mbUseScreenRatioPosition>("UseScreenRatioPosition"_hs)
		.prop(fq::reflect::prop::Name, "UseScreenRatioPosition")
		.prop(fq::reflect::prop::Comment, u8"스크린 비율 위치 설정")
		.data<&ImageUI::mScreenRatioPosition>("ScreenRatioPosition"_hs)
		.prop(fq::reflect::prop::Name, "ScreenRatioPosition")
		.base<Component>();
