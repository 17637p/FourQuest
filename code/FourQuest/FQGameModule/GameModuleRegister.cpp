...
void fq::game_module::RegisterMetaData()
{
...

	{
		...
		entt::meta<DecalMaterialInfo>()
			.type("DecalMaterialInfo"_hs)
			.prop(fq::reflect::prop::Name, "DecalMaterialInfo")
			.prop(fq::reflect::prop::POD)
			.data<&DecalMaterialInfo::bUseBaseColor>("bUseBaseColor"_hs)
			.prop(fq::reflect::prop::Name, "bUseBaseColor")
			.data<&DecalMaterialInfo::bUseMetalness>("bUseMetalness"_hs)
			.prop(fq::reflect::prop::Name, "bUseMetalness")
			.data<&DecalMaterialInfo::bUseRoughness>("bUseRoughness"_hs)
			.prop(fq::reflect::prop::Name, "bUseRoughness")
			.data<&DecalMaterialInfo::bUseNormalness>("bUseNormalness"_hs)
			.prop(fq::reflect::prop::Name, "bUseNormalness")
			.data<&DecalMaterialInfo::bUseEmissive>("bUseEmissive"_hs)
			.prop(fq::reflect::prop::Name, "bUseEmissive")
			.data<&DecalMaterialInfo::TextureBasePath>("TextureBasePath"_hs)
			.prop(fq::reflect::prop::Name, "TextureBasePath")
			.prop(fq::reflect::prop::RelativePath)
			.data<&DecalMaterialInfo::BaseColorFileName>("BaseColorFileName"_hs)
			.prop(fq::reflect::prop::Name, "BaseColorFileName")
			.prop(fq::reflect::prop::RelativePath)
			.prop(fq::reflect::prop::DragDrop, ".png/.jpg")
			.data<&DecalMaterialInfo::MetalnessFileName>("MetalnessFileName"_hs)
			.prop(fq::reflect::prop::Name, "MetalnessFileName")
			.prop(fq::reflect::prop::RelativePath)
			.prop(fq::reflect::prop::DragDrop, ".png/.jpg")
			.data<&DecalMaterialInfo::RoughnessFileName>("RoughnessFileName"_hs)
			.prop(fq::reflect::prop::Name, "RoughnessFileName")
			.prop(fq::reflect::prop::RelativePath)
			.prop(fq::reflect::prop::DragDrop, ".png/.jpg")
			.data<&DecalMaterialInfo::NormalFileName>("NormalFileName"_hs)
			.prop(fq::reflect::prop::Name, "NormalFileName")
			.prop(fq::reflect::prop::RelativePath)
			.prop(fq::reflect::prop::DragDrop, ".png/.jpg")
			.data<&DecalMaterialInfo::EmissiveFileName>("EmissiveFileName"_hs)
			.prop(fq::reflect::prop::Name, "EmissiveFileName")
			.prop(fq::reflect::prop::RelativePath)
			.prop(fq::reflect::prop::DragDrop, ".png/.jpg");

		entt::meta<MaterialControllInfo>()
			.type("MaterialControllInfo"_hs)
			.prop(fq::reflect::prop::Name, "MaterialControllInfo")
			.data<&MaterialControllInfo::bTryLoadTexture>("bTryLoadTexture"_hs)
			.prop(fq::reflect::prop::Name, "bTryLoadTexture");

		entt::meta<DecalInfo>()
			.type("DecalInfo"_hs)
			.prop(fq::reflect::prop::Name, "DecalInfo")
			.prop(fq::reflect::prop::POD)
			.data<&DecalInfo::NormalThresholdInDegree>("NormalThresholdInDegree"_hs)
